...
The current public version is **v0.2.0** and is licensed under the MIT
License. The Public GitHub repository and the `v0.2.0` Release are available.
Current evidence covers local Codex behavior and the Windows public clone
canary; Claude, other hosts, and other operating systems remain **unverified**.
...
The public repository root is this `src/` directory. The runtime Skill is the
...
not authorize deletion, migration, or external synchronization merely because
...
The public `v0.2.0` release is available; future changes should preserve the
same evidence and authorization boundaries.
